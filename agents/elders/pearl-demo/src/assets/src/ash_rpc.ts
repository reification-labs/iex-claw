...
export type TodoResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "completed" | "title";
  id: UUID;
  completed: boolean;
  title: string;
};
...
// TodoEvents Schema
export type TodoEventsResourceSchema = {
  __type: "Resource";
...
export type TodoEventsFilterInput = {
  and?: Array<TodoEventsFilterInput>;
  or?: Array<TodoEventsFilterInput>;
  not?: Array<TodoEventsFilterInput>;
...
export async function validateGetTodo(
  config: {
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
...
export type InferCreateTodoResult = Record<string, any>;

export type CreateTodoResult = | { success: true; data: InferCreateTodoResult; }
| { success: false; errors: AshRpcError[]; }
...
export async function createTodo(
  ...
  return executeActionRpcRequest<CreateTodoResult>(
    payload,
    config
  );
}
...
export const toggleTodoZodSchema = z.object({
  todoId: z.uuid().optional(),
});

export type InferToggleTodoResult = Record<string, any>;

export type ToggleTodoResult = | { success: true; data: InferToggleTodoResult; }
| { success: false; errors: AshRpcError[]; }
...
export async function toggleTodo(
  ...
  return executeActionRpcRequest<ToggleTodoResult>(
    payload,
    config
  );
}
...
export async function validateToggleTodo(
  config: {
  input?: ToggleTodoInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
...
export const updateTitleZodSchema = z.object({
  todoId: z.uuid().optional(),
  title: z.string().optional(),
});

export type InferUpdateTitleResult = Record<string, any>;

export type UpdateTitleResult = | { success: true; data: InferUpdateTitleResult; }
| { success: false; errors: AshRpcError[]; }
...
export async function updateTitle(
  ...
  return executeActionRpcRequest<UpdateTitleResult>(
    payload,
    config
  );
}
...
export async function validateUpdateTitle(
  config: {
  input?: UpdateTitleInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
...
export const deleteTodoZodSchema = z.object({
  todoId: z.uuid().optional(),
});

export type InferDeleteTodoResult = Record<string, any>;

export type DeleteTodoResult = | { success: true; data: InferDeleteTodoResult; }
| { success: false; errors: AshRpcError[]; }
...
export async function deleteTodo(
  ...
  return executeActionRpcRequest<DeleteTodoResult>(
    payload,
    config
  );
}
...
export async function validateDeleteTodo(
  config: {
  input?: DeleteTodoInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
