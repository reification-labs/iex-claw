...
config :reify, ReifyWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "scZQOKaLVvIrKr+xu/8o7kQ87oHbpUgYeK28ujKmFh2tpZ3OfHWyRR2EJyjoPDco",
  watchers: [
...
# Configure LiveReact for development
# vite_host can be overridden in runtime.exs for Codespaces/Docker
config :live_react,
